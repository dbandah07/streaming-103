    ...
    while(option != 0) {
        ...
        try {
            if(option == 1) {
                ...
                catch (const UserNotLoggedInError& error1) {
                    // cout << "DEBUG: reaches block 1." << endl;

                    cout << no_user_except_msg << endl;
                }  
                catch (const RatingLimitError& error2) {
                    // cout << "DEBUG: reaches block 2." << endl;

                    cout << rating_limit_except_msg << endl;
                }
                catch (const std::exception& error3) {
                    // cout << "DEBUG: reaches block 3." << endl;
                ...
                try {
                    ...
                    // cout << "DEBUG: reaches block 4." << endl;
                    cout << no_user_except_msg << endl;
                }  
                catch (const ReviewRangeError) {
                    // cout << "DEBUG: reaches block 5." << endl;
                    cout << review_range_except_msg << endl;
                }
                catch (const std::exception& error3) {
                    // cout << "DEBUG: reaches block 6." << endl;
                    cout << "Error processing command." << endl;
                }
        ...
        // Potentially add more catch blocks here, as necessary
            ...
            // cout << "DEBUG: reaches block 7." << endl;

            cout << no_user_except_msg << endl;
        }  
        catch(...) {
            // cout << "DEBUG: reaches block 8." << endl;
